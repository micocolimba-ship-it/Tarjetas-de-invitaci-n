...
<div class="w-full min-h-screen bg-[#F7F4EF] text-[#2D2D2D] py-10 px-4 sm:px-8 font-sans flex flex-col items-center selection:bg-[#C7A873]/20" style="font-family: '{{fontBody}}', sans-serif;">
  ...
  <div class="w-full max-w-xl bg-white rounded-[32px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.03)] border border-[#E9E3DA] mb-8 transition-transform duration-500 hover:shadow-[0_12px_40px_rgb(0,0,0,0.05)]">
    ...
    <div class="p-8 sm:p-12 text-center flex flex-col items-center">
      ...
      <h1 class="text-3xl sm:text-4xl text-[#2D2D2D] leading-tight tracking-tight mb-4" style="font-family: '{{fontTitle}}', serif;">
        {{title}}
      </h1>
      ...
      <p class="text-base font-medium text-[#2D2D2D] mb-6 italic" style="font-family: 'Cormorant Garamond', 'Playfair Display', serif;">
        {{hostName}}
      </p>
  ...
  <!-- RSVP Primary Form Button -->
  <div class="w-full max-w-xl bg-white rounded-[32px] p-8 sm:p-10 shadow-[0_12px_40px_rgba(199,168,115,0.08)] border border-[#C7A873]/20 mb-8 text-center flex flex-col items-center">
    <span class="text-[10px] uppercase tracking-[0.3em] text-[#C7A873] font-bold mb-4">Confirmación de Asistencia</span>
    <h3 class="text-lg sm:text-xl text-[#2D2D2D] font-bold mb-2">¿Nos acompañas en este día especial?</h3>
    <p class="text-[11px] text-[#777777] mb-6 max-w-xs leading-relaxed">
      Por favor, confirma tu asistencia a través de nuestro botón oficial de contacto.
    </p>
    
    <a href="https://wa.me/{{whatsappContact}}" target="_blank" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#2D2D2D] hover:bg-[#1E1E1E] text-white text-[10px] font-bold uppercase tracking-[0.2em] px-8 py-4 rounded-full transition-all hover:scale-[1.02] shadow-md">
  ...
  <div class="text-center mt-6 mb-4">
    <p class="text-[9px] uppercase tracking-[0.3em] text-[#777777] font-bold">Tarjeta Familiar</p>
    <p class="text-[8px] text-[#C7A873] mt-1 font-mono">EDITORIAL COLLECTION • V1.0</p>
  </div>
</div>`
};
