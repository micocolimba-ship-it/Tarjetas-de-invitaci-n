...
export const INITIAL_EVENTS: EventData[] = [
  ...
  },
  {
    ...
    type: 'cumpleanos',
    style: 'editorial-passport-v1',
    title: 'Celebración 50 Años',
    hostName: 'Lina María Arias Rincón',
    date: '2026-11-28',
    time: '17:30',
    locationName: 'Salón de Eventos Terraza Real',
    locationAddress: 'Cl. 127 #15-36, Bogotá, Colombia',
    locationMapsUrl: 'https://maps.google.com',
    description: 'Los mejores viajes no siempre nos llevan a nuevos lugares. Algunos simplemente celebran el camino recorrido. Acompáñanos a conmemorar el vuelo dorado de Lina María Arias Rincón.',
    whatsappContact: '+573123456789',
    musicConfig: {
      enabled: true,
      audioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',
      songName: 'Vuelo de Ensueño (Jazz)',
